...
class LDA_VI:
    def __init__(self, alpha, eta, K, eta_seed=None, eta_not_seed=None, seed_words=None,
                 confirmatory=None, evaluate_every=10, two_phase_words=[]):
        # loading data
    ...
    def _init_params(self, X, cv):
        ...
        if self.confirmatory:
            ...
            self.eta = self.eta_ordinary * np.ones((self.K+1, self.V))
        ...
        self.eta[self.K, np.array(self.two_phase_words_idx)] = self.eta_not_seed
